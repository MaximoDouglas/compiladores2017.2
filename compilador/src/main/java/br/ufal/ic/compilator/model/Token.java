...
public class Token {
	...
	//conta n˙mero de espaÁos em branco no comeÁo da linha
	...
	//remove os espaÁos em branco no final das linhas
	...
	//reconhece e retorna o prÛximo token
	...
	public String toString() {
		...
		if(this.categorie == Categories.TK_ER_CH) {
			string += ". Erro: ' esperado na posi√ß√£o [" + String.format("%03d", this.lineIndex + 1) + ", " + String.format("%03d", this.colIndex + this.lexema.length() + 1) + "]";
